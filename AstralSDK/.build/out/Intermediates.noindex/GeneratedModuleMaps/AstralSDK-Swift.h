...
// Generated by Apple Swift version 6.4 effective-5.10 (swiftlang-6.4.0.25.4 clang-2100.3.25.1)
#ifndef ASTRALSDK_SWIFT_H
#define ASTRALSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AstralSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///   </li>
///   <li>
///     Does NOT auto-ACK. Calls <code>onRawDataReceived</code> and waits for SDK
///     to verify before sending acknowledgment
///   </li>
///   <li>
///     Uses <code>PacketFragmenter</code> for packets > BLE MTU
///   </li>
/// </ul>
SWIFT_CLASS("_TtC9AstralSDK12BLETransport")
...
@class NSString;
@class NSNumber;
@interface BLETransport (SWIFT_EXTENSION(AstralSDK)) <CBCentralManagerDelegate>
...
@interface BLETransport (SWIFT_EXTENSION(AstralSDK)) <CBPeripheralManagerDelegate>
...
@interface BLETransport (SWIFT_EXTENSION(AstralSDK)) <CBPeripheralDelegate>
